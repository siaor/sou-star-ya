      ...
      <div class="ya-fast-menu-pop-content">
        <div class="ya-fast-menu-pop-content-left">
          ...
          <div class="ya-fast-menu-pop-content-item">
            ...
            <div class="ya-fast-menu-pop-content-item-conf">
              <label>是否可拖拽</label>
              <input type="text" v-model="isDragRef" @change="afterChange" placeholder="请填写true或false">
            </div>
            <div class="ya-fast-menu-pop-content-item-conf">
              <label>图标地址</label>
...
function openPop(mod: string, x: number, y: number) {
  switch (mod) {
    case "AppMod":
      ...
      isDragRef.value = appModConf.isDrag;
      break;
    case "GroupMod":
      ...
      isDragRef.value = groupModConf.isDrag;
      break;
    default:
...
function afterChange() {
  ...
  switch (mod) {
    case "AppMod":
      modRef.value.conf.logo = logoRef.value;
      modRef.value.conf.url = urlRef.value;
      modRef.value.conf.name = nameRef.value;
      break;
    case "GroupMod":
      modRef.value.conf.logo = logoRef.value;
      modRef.value.conf.name = nameRef.value;
  ...
  modRef.value.conf.x = xRef.value;
  modRef.value.conf.y = yRef.value;
  modRef.value.conf.isDrag = isDragRef.value;
